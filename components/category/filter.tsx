import { Close, Rating } from "../common/";
...
const Filter = ({ handleDeleteCollection, showCollection }: propsI) => {
  return (
    <div
      className={
        "absolute left-[0] top-[0] bottom-[0]  min-h-[100vh] bg-[rgba(0,0,0,0.4)] w-full right-[0]  " +
        `${showCollection ? "opacity-1" : " opacity-0 -z-20"}`
      }
    >
      <div
        className={
          "bg-white overflow-y-auto  h-[100vh] transition-all duration-[.5s]  right-0 w-full max-w-[325px] px-[1.3rem] py-[1.5rem]" +
          `${showCollection ? " " : " p-0 w-0"}`
        }
      >
        ...
        <ul className="text-primary font-poppins mt-[2rem] text-[1.1rem] capitalize">
          <li className="mb-[1rem]">
            men <span className="text-fourth">(5)</span>
          </li>
          <ul className="pl-[1.5rem]">
            <li className="mb-[.3rem]">
              running <span className="text-fourth">(1)</span>
            </li>
            <li className="mb-[.3rem]">
              sneakers <span className="text-fourth">(3)</span>
            </li>
            <li className="mb-[.3rem]">
              training <span className="text-fourth">(1)</span>
            </li>
          </ul>
        </ul>
        <ul className="text-primary font-poppins mt-[2rem]  text-[1.1rem] capitalize">
          <li className="mb-[1rem]">
            women <span className="text-fourth">(5)</span>
          </li>
          <ul className="pl-[1.5rem]">
            <li className="mb-[.3rem]">
              running <span className="text-fourth">(1)</span>
